...
map<string, vector<double> > get_windowStats( vector<int> &positions, vector<bitset<bitlength>> &sample, int S );  /// new chp 6 ////


// definitions
double get_pi (vector<bitset<bitlength>> &sample) {  // pass by reference
...
double get_watterson (int S) { // pass by reference
...
map<string, vector<double> > get_windowStats( vector<int> &positions, vector<bitset<bitlength>> &sample, int S ) {
	...
	//vector<double> pi, watterson, tajd;
